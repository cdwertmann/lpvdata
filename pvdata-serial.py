...
class IstWerte:
	...
	def write_rrd(self):
		if not "ist4" in data: return
		v = "N:"+str(data["ist4"])
		os.system("rrdtool update istwerte.rrd " + v)
...
connect<-dbConnect(driver, dbname = \"lzwerte.sq3\")\n")
